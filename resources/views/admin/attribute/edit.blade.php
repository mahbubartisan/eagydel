        ...
        <div class="col-lg-8 col-xl-8 mt-3">
            <div class="card">
                <div class="card-body">
                    ...
                    {{-- <input type="hidden" name="attribute_id" value="{{ $attr_value->first()->attribute_id }}"> --}}
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">
            ...
            <div class="mt-3 mb-5">
                <input type="submit" style="float:right" class="btn btn-lg btn-primary" value="Update Attribute">
            </div>
        </div>
        </form>
    </section>
