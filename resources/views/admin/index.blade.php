...
@php
    ...
    $users = App\Models\Order::withCount('user')->first();
    $order_date = date('d F Y');
    $today_sales = App\Models\Order::where('order_date', $order_date)->sum('amount');
            ...
            <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                <div class="card-body text-center"><i class="i-Add-User"></i>
                    <div class="content">
                        ...
                        <p class="text-primary text-24 line-height-1 mb-2">{{ $users->user_count }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                <div class="card-body text-center"><i class="i-Financial"></i>
                    <div class="content">
                        ...
                        <p class="text-primary text-24 line-height-1 mb-2">${{ $sales }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                <div class="card-body text-center"><i class="i-Money-2"></i>
                    <div class="content">
                        <p class="text-muted mt-2 mb-0">Today Sale</p>
                        <p class="text-primary text-24 line-height-1 mb-2">${{ $today_sales }}</p>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><img class="rounded-circle m-0 avatar-sm-table" 
                                                src="{{ asset('backend/assets/images/faces/1.jpg') }}" alt="" /></td>
