								...
								<tr>
									<td class="content-cell"
										...
										<h1
											...
											Hello!{{ $order_mail['first_name'] }} {{ $order_mail['last_name'] }}</h1>
										<p
											...
											THANK YOU FOR YOUR ORDER FROM EMART ONLINE SHOP.</p>
															...
															<td align="center"
																...
																<table border="0" cellpadding="0" cellspacing="0" role="presentation"
																	...
																	<tr>
																		...
																		<td>
																			Your Invoice #{{ $order_mail['invoice_no'] }}
																		</td>

																		<td>
																			Order #{{ $order_mail['order_no'] }}
																		</td>

																		<td>
																			Grand Total ${{ $order_mail['amount'] }}
																		</td>
																	</tr>
																</table>
															</td>
								...
								<tr>
									<td class="content-cell" align="center"
										...
										<p
											...
											© 2022 Emart Online Shop. All rights reserved.</p>
