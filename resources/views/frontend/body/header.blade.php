					...
					<div class="search-area">
						<form action="{{ route('search.product') }}" method="POST">
							...
							<div class="control-group">
								...
								<input name="search" id="search" onfocus="searchResultShow()" onblur="searchResultHide()"
									class="search-field" autocomplete="off" placeholder="Search here..." />
					...
					<div class="dropdown dropdown-cart"> <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
							<div class="items-cart-inner">
								...
								<div class="total-price-basket"> <span class="lbl">cart -</span> <span class="total-price">
										<span class="sign">$</span><span class="value" id="subTotal"></span></span></div>
							</div>
						</a>
						<ul class="dropdown-menu">
							<li>
							...
							<ul class="nav navbar-nav">
								...
								@foreach ($types as $type)
									<li class="dropdown yamm mega-menu"> <a href="home.html" data-hover="dropdown" class="dropdown-toggle"
											data-toggle="dropdown">{{ $type->type_eng }}</a>
														...
														@foreach ($parent_categories as $parent_category)
															<div class="col-xs-12 col-sm-6 col-md-2 col-menu">
																...
																<a
																	...
																	<h2 class="title">{{ $parent_category->category_name_eng }}</h2>
																</a>
