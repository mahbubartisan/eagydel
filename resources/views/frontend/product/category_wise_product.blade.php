					...
					<div id="myTabContent" class="tab-content category-list">
						<div class="tab-pane active " id="grid-container">
							<div class="category-product">
								<div class="row">
									...
									@forelse ($cat_wise_products as $cat_wise_product)
										<div class="col-sm-6 col-md-4 wow fadeInUp">
											<div class="products">
												<div class="product">
													<div class="product-image">
														<div class="image"> <a href="{{ url('product/detail/' . $cat_wise_product->id) }}"><img
																	src="{{ asset($cat_wise_product->thumb_image) }}" alt=""></a> </div>
														<!-- /.image -->
													...
													<div class="product-info text-left">
														<h3 class="name"><a href="{{ url('product/detail/' . $cat_wise_product->id) }}">
																@if (session()->get('language') == 'hindi')
																	{{ $cat_wise_product->product_name_hindi }}
																@else
																	{{ $cat_wise_product->product_name_eng }}
																@endif
															</a></h3>
						...
						<div class="tab-pane" id="list-container">
							<div class="category-product">
											...
											<div class="product-list product">
												<div class="row product-list-row">
													<div class="col col-sm-4 col-lg-4">
														<div class="product-image">
															<div class="image"> <img src="{{ asset($cat_wise_product->thumb_image) }}" alt="image"> </div>
														</div>
														<!-- /.product-image -->
													</div>
													<!-- /.col -->
								...
								@empty
									<h4 class="text-color-red">No product found...</h4>
								@endforelse
							</div>
							<!-- /.category-product -->
						</div>
